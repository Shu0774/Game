...
let tekiMaster=[
	...
	new TekiMaster(3,10,1,10),				//3,ボスひよこの子供(黄色)
]
*/

let tekiMaster=[
	new TekiMaster(0,15,1,100),				//0,モンゴル_1
	new TekiMaster(1,15,1,100),				//1,モンゴル_2
	new TekiMaster(2,90,5000,10000),		//2,ボスモンゴル
	new TekiMaster(3,15,1,10),				//3,ボスモンゴルの子供(黄色)
]
...
let sprite =[
	...
	new Sprite(312,288,168,191),//78  ,モンゴル人_ボス
	new Sprite(13,393,41,54),   //79  ,モンゴル人_ver2
	new Sprite(62,397,35,50),   //80  ,モンゴル人_ver3
	new Sprite(107,396,36,51),  //81 ,モンゴル人_ver4
	new Sprite(176,16,22,26),   //82  ,なぎ弾
	new Sprite(210,15,30,30)	//83  ,ピッツ弾
