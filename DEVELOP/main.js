...
let drawCount = 0;
let fps = 0;
let lastTime = Date.now();  //時刻をミリ秒単位で取得
...
spriteImage1.src = "sprite1.png";

let spriteImage2 = new Image();
spriteImage2.src = "sprite2.png";

let spriteImage3 = new Image();
spriteImage3.src = "sprite3.png";
...
function putInfo() 
{
    ...
    if (DEBUG) {
        ...
        con.fillText("Expl:" + teta.length, 20, 100);
